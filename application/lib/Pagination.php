...
class Pagination {
    ...
    public function __construct($route, $total, $limit = 2, $sort = '') {
        $this->route = $route;
        $this->total = $total;
        $this->limit = $limit;
        $this->sort = $sort;
    ...
    private function generateHtml($page, $text = null) {
        ...
        return '<li class="page-item"><a class="page-link" href="/'.$this->route['controller'].'/'.$this->route['action'].'/'.$page.$sort.'">'.$text.'</a></li>';
    }
